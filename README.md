...
Pink Salt is a cozy, pink-and-white, Obsidian‑inspired note‑taking app for Windows. This "Claudia Edition" adds rich Markdown editing, note graph visualization, wiki‑style links, and a full soft pink theme.
